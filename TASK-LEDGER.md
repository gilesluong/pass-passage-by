...
2. NEXT — Portable annotation/comment presentation metadata in exports (NotePresentation defaults already route surfaces in-app; exports must carry the surface map without touching frozen Model.swift or reclassifying historical kind=comment notes).
